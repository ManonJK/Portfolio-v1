...
<main>
    ...
    <div class="card-columns">
        ...
        <div class="card click" onclick="window.location.href='Articles/wwh.php';">
        ...
        <div class="card click">
            ...
            <div class="card-body">
                ...
                <p class="card-text">This card has supporting text below as a natural lead-in to additional content.</p>
                <p class="card-text"><small class="text-muted">Le 02 janvier 2019fg èrh"uyfnr'_çeizux</small></p>
            </div>cx
        </div>
    </div>
